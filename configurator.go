...
// Configurator определяет интерфейс для загрузки и доступа к конфигурации приложения.
// Предоставляет методы для получения значений различных типов по строковому ключу.
//
